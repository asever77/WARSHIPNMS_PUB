          ...
          <tr>
            ...
            <td>
              <div class="d-flex w100-2">
                <BFormCheckbox v-model="formData.callAuth" value="1">발신</BFormCheckbox>
                <BFormCheckbox v-model="formData.callAuth" value="2">착신</BFormCheckbox>
              </div>
            </td>
          </tr>
          <tr>

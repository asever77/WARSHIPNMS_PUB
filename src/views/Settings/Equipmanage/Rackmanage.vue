<template>
      ...
      <BTable :items="paginatedItems" :fields="fields" bordered hover small responsive>
        ...
        <template #cell(count)="data">
          <div class="ui-flex"data-item-align="center" data-justify-align="end" data-gap="8">
            <span>5</span>
            <BButton class="gray24 min-w-0" @click="modals.modalRackOption.show = true">{{ lang.btnAdd }}</BButton>
          </div>
        </template>
      </BTable>
  ...
  <div class="ui-btn-group">
    <BButton class="blue28" @click="modals.modalRackRegister.show = true">{{ lang.btnRegister }}</BButton>
    <BButton class="gray28">{{ lang.btnDelete }}</BButton>
  </div>

  <!-- modal 랙 정보 등록 -->
  <UiModal v-model="modals.modalRackRegister.show" :title="lang.modalTitle1" type="modal" size="md" @close-btn-click="modals.modalRackRegister.show = false">
  ...
  <!-- modal 랙 구성품 -->
  <UiModal v-model="modals.modalRackOption.show" :title="lang.modalTitle2" type="modal" size="xl" no-footer @close-btn-click="modals.modalRackOption.show = false">
    <div class="ui-flex modal-h-full" data-gap="16">
      ...
      <div>
        ...
        <div class="ui-btn-group">
          <BButton class="gray28" @click="modals.modalRackOption.show = false">{{ lang.btnCancel }}</BButton>

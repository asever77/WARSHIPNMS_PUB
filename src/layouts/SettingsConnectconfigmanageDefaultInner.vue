...
onMounted(() => {
  ...
  tabList.value = [
    { label: lang.value.menu1, path: '/settings/connectconfigmanage/interlockdevice/service' },
    { label: lang.value.menu2, path: '/settings/connectconfigmanage/interlockdevice/port' },
